      ...
      <div className="project__hot-pepper-beauty-inner">
        ...
        <div className="project__hot-pepper-beauty-content">
          <p className="mb-10 font-light font-jost phone:text-sm">
            ...
            effectively showcased the company's market size to its customers. This involved working with data and
            seamlessly integrating Chart JS into the platform. I maintained close collaboration with a Frontend
            Developer from Japan throughout the project.
          </p>
